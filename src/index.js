...
var frequency_list = [
  ...
  { text: "physics", size: 120 },
  { text: "describing", size: 5 },
  { text: "matter", size: 90 },
  { text: "physics-the", size: 5 },
  { text: "world", size: 10 },
  { text: "works", size: 10 },
  ...
  { text: "nature", size: 40 },
  { text: "branch", size: 30 },
  { text: "concerned", size: 25 },
  { text: "source", size: 40 },
  { text: "google", size: 10 },
  { text: "defintions", size: 5 },
  { text: "two", size: 15 },
  ...
  { text: "org", size: 25 },
  { text: "answers", size: 5 },
  { text: "natural", size: 15 },
  { text: "objects", size: 5 },
  { text: "treats", size: 10 },
  { text: "acting", size: 5 },
  { text: "department", size: 5 },
  { text: "gravitation", size: 5 },
  { text: "heat", size: 10 },
  { text: "light", size: 10 },
  ...
  { text: "bodies", size: 5 },
  { text: "philosophy", size: 5 },
  { text: "brainyquote", size: 5 },
  { text: "words", size: 5 },
  { text: "ph", size: 5 },
  { text: "html", size: 5 },
  { text: "lrl", size: 5 },
  { text: "zgzmeylfwuy", size: 5 },
  { text: "subject", size: 5 },
  ...
  { text: "behaves", size: 5 },
  { text: "en", size: 5 },
  { text: "wikipedia", size: 5 },
  { text: "wiki", size: 5 },
  { text: "physics-", size: 5 },
  { text: "physical", size: 5 },
  { text: "behaviour", size: 5 },
  { text: "collinsdictionary", size: 5 },
  { text: "english", size: 5 },
  { text: "time", size: 35 },
  { text: "distance", size: 35 },
  { text: "wheels", size: 5 },
  { text: "revelations", size: 5 },
  { text: "minute", size: 5 },
  { text: "acceleration", size: 20 },
  { text: "torque", size: 5 },
  { text: "wheel", size: 5 },
  { text: "rotations", size: 5 },
  { text: "resistance", size: 5 },
  { text: "momentum", size: 5 },
  { text: "measure", size: 10 },
  { text: "direction", size: 10 },
  { text: "car", size: 5 },
  { text: "add", size: 5 },
  { text: "traveled", size: 5 },
  { text: "weight", size: 5 },
  { text: "electrical", size: 5 },
  { text: "power", size: 5 }
];
