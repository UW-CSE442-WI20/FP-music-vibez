...
},{"d3-dispatch":"../node_modules/d3-dispatch/src/index.js"}],"../node_modules/d3-simple-slider/src/slider.js":[function(require,module,exports) {
"use strict";
...
},{"d3-array":"../node_modules/d3-array/src/index.js","d3-axis":"../node_modules/d3-axis/src/index.js","d3-dispatch":"../node_modules/d3-dispatch/src/index.js","d3-drag":"../node_modules/d3-drag/src/index.js","d3-ease":"../node_modules/d3-ease/src/index.js","d3-scale":"../node_modules/d3-scale/src/index.js","d3-selection":"../node_modules/d3-selection/src/index.js","d3-transition":"../node_modules/d3-transition/src/index.js"}],"../node_modules/d3-simple-slider/index.js":[function(require,module,exports) {
"use strict";
...
},{"./src/slider.js":"../node_modules/d3-simple-slider/src/slider.js"}],"index.js":[function(require,module,exports) {
// libraries
var d3 = require("d3");
...
var color = d3.scaleLinear().domain([0, 1, 2, 3, 4, 5, 6, 10, 15, 20, 100]).range(["#ED3108", "#7AD00C", "#ED0827", "#ED086D", "#EA08ED", "#9308ED", "#084AED", "#08C3ED", "#08ED96", "#58ED08", "#EAED08", "#0A0909"]);
var layout = cloud().size([500, 500]).words(frequency_list).padding(5).rotate(function () {
...
function draw(words) {
  d3.select("body").append("svg").attr("width", layout.size()[0]).attr("height", layout.size()[1]).append("g").attr("transform", "translate(" + layout.size()[0] / 2 + "," + layout.size()[1] / 2 + ")").selectAll("text").data(words).enter().append("a").attr("href", function (d) {
    return "/index4.html?query=" + d.text;
    ...
    d3.select(this).transition().duration(100).style("font-size", function (d) {
...
var yearsSelected = [1960, 1995]; // Range Slider 

var sliderRange = slider.sliderBottom().min(d3.min(yearsData)).max(d3.max(yearsData)).width(300).marks(yearsData).tickFormat(d3.format('.0f')).ticks(10).default(yearsSelected).fill('#045DE9').on('onchange', function (val) {
  d3.select('p#value-range').text(val.map(d3.format('.0f')).join(' - '));
  yearsSelected = val;
});
var gRange = d3.select('div#slider-range').append('svg').attr('width', 500).attr('height', 100).append('g').attr('transform', 'translate(30,30)');
gRange.call(sliderRange);
d3.select('p#value-range').text(sliderRange.value().map(d3.format('.0f')).join(' - '));
},{"d3":"../node_modules/d3/index.js","d3-cloud":"../node_modules/d3-cloud/index.js","d3-simple-slider":"../node_modules/d3-simple-slider/index.js"}],"../node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
